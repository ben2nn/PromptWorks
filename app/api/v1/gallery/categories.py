...
from .exceptions import GalleryValidationError, GalleryDatabaseError, safe_execute
...
def get_gallery_categories(
    *,
    ...
    try:
        # 直接调用现有的API端点
        result = safe_execute(list_prompt_classes, db=db, q=None, limit=limit, offset=0)

...
class ThumbnailService:
    ...
    def generate_thumbnail(
        self, image_content: bytes, output_format: str = "JPEG"
    ) -> bytes:
        """生成缩略图
    ...
    def create_thumbnail_filename(
        self, original_filename: str, thumbnail_format: str
    ) -> str:
        """创建缩略图文件名
    ...
    def process_image(
        self, image_content: bytes, original_filename: str, mime_type: str
        ...
        # 创建缩略图文件名
        thumbnail_filename = self.create_thumbnail_filename(
            original_filename, thumbnail_ext
        )
